namespace ORM.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ORM.SIGEeLDBContext>
    {
        ...
        protected override void Seed(ORM.SIGEeLDBContext context)
        {
            ...
            #region Country
            //Country c = new Country("República Dominicana", "0e6f4647-e983-403d-af17-062dbf9021e4") ;
            //context.Countries.AddOrUpdate(co => co.CountryName, c);

            #endregion

            #region Regions
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("36538b54-ed1a-8704-7f3a-5256cfbef59d", "Altagracia", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("4270074d-5e7a-55c7-d6a3-5256cf25c071", "Azua", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("507dfd4f-0857-be81-b68b-5256cf1c670b", "Bahoruco", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("609ab191-e2f2-e550-7ca0-5256cfa9bb28", "Barahona", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("6caea519-7bec-34be-449b-5256cfe7e341", "Dajabón", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("2516e95e-8877-f720-6df7-5256cfcfeaea", "Distrito Nacional", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("78d4de14-ef8c-d5fa-24ad-5256cf6f6298", "Duarte", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("84f1f020-67c8-073a-6722-5256cf654bf6", "El Seibo", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("9102b71d-7a58-0a48-f2bd-5256cfd6257d", "Elias Piña", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("9d1f37c0-d69c-cbe6-f10b-5256cf6456db", "Espaillat", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("a92edf91-d65b-e3de-8d7e-5256cff402d6", "Hato Mayor", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("3e0a2cbf-19cf-1ada-3c6d-5256cf999f85", "Hermanas Mirabal", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("b54c3dbf-24fe-dce5-e4d5-5256cf59a811", "Independencia", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("c15af755-ed1e-0819-0eaa-5256cf67e23a", "La Romana", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("d1797b1c-6777-2d56-c60a-5256cf33e2b0", "La Vega", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("dd872718-cff6-49bf-412c-5256cf483e1e", "María Trinidad Sánchez", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("e9ae396c-b33f-f2d7-b303-5256cfdcbe98", "Monseñor Nouel", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("dae10512-80db-2c3d-f2de-5256cffac887", "Monte Plata", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("19df059d-5287-62b9-bca8-5256cffa92f9", "Montecristi", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("19c9085f-2da0-9b77-0449-5256cfa99cb8", "Pedernales", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("25db66c3-be2b-0ed5-9a6c-5256cf551dd0", "Peravia", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("31f78a39-87fc-d712-0a3c-5256cf8abd2e", "Puerto Plata", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("4a24988c-8d50-c251-2c3d-5256cfb1da60", "Samaná", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("56355c75-f9ef-a34a-568f-5256cf4257b7", "San Cristóbal", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("c721733a-ecd0-3e1a-f64f-5256cfea1c23", "San José de Ocoa", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("6252f600-694a-412a-778c-5256cf7ffc65", "San Juan de la Maguana", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("6e612a7a-5ecf-d2b4-25d1-5256cf5be2d5", "San Pedro de Macoris", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("7bb58279-70be-f9a6-c4ba-5256cf4ce4f9", "Sánchez Ramírez", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("8e9e12de-9c28-30cd-4bc5-5256cf0fc1e4", "Santiago de los Caballeros", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("9aba9d41-3d30-fd20-47c2-5256cf05bfaf", "Santiago Rodríguez", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("e740c3bf-2835-925e-4da9-5256cf73feaa", "Santo Domingo", new Country().GetCountryByName(context, "República Dominicana")));
            context.Regions.AddOrUpdate(h => h.RegionName, new Region("a6f5174d-b955-edc7-688b-5256cf72115e", "Valverde", new Country().GetCountryByName(context, "República Dominicana")));
            ...
            context.Localities.AddOrUpdate(h => h.LocalityName, new Locality("7a11ece8-b4ba-444c-c27d-5256d5e43171", "DOÑA EMMA BALAGUER VDA. VALLEJO", new Region().GetRegionByName(context, "Azua")));
